export default function MembresiaActionModal({
  ...
  const configuracion = {
    ...
    suspender: {
      ...
      mensaje:
        "¿Está seguro de que desea suspender esta membresía?",
      boton:
        "Sí, suspender membresía",
      color:
        "amber",
    },
    ...
    activar: {
      ...
      mensaje:
        "¿Está seguro de que desea activar esta membresía por un mes?",
      boton:
        "Sí, activar por un mes",
      color:
        "green",
    },
