...
namespace Elysia.Presentation.WebApi.Controllers.v2
{
    [ApiVersion("2.0")]
    public class AccountController : BaseApiController
    {
        ...
        public async Task<IActionResult> LoginUse(LoginDto dto)
        {
        ...
        [HttpPost("register-user-account")]
        ...
        public async Task<IActionResult> RegisterUser(RegisterUserRequestDto dto)
        {
            ...
            try
            {
                ...
                var editUser = await accountServices.EditUser(map);
